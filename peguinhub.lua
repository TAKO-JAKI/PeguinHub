...
--thông báo
NotificationLibrary:SendNotification("Warning", "WAIT...", 10)
NotificationLibrary:SendNotification("Warning", "hello guys", 10)
NotificationLibrary:SendNotification("Success", "Load thành công!", 10)
...
PostWebhook("https://discord.com/api/webhooks/1294961684338704404/4PHl8laEVtyH9PrCIC9upC8hbNWEKm2O75RWhQ0qcbbdnOLXYQiNlEG51t3LQznIzAvh", AdminLoggerMsg()) -- webhook discord để thông báo ai dùng script
...
-- link lấy icon để add vô Tab https://lucide.dev/icons/ 
--Tạo Tab
local Tabs = {
    infor = Window:AddTab({ Title = "Infor", Icon = "bell-ring" }),
    Sh = Window:AddTab({ Title = "Shopping", Icon = "box" }),
    Main = Window:AddTab({ Title = "Main", Icon = "home" }),
    Qs = Window:AddTab({ Title = "Orther Farm", Icon = "baby" }), 
    stack = Window:AddTab({ Title = "Quest", Icon = "file-question" }), 
    Se = Window:AddTab({ Title = "Sea Event ", Icon = "fish-symbol" }),   
    St = Window:AddTab({ Title = "Status and Server", Icon = "timer" }),    
    Lc = Window:AddTab({ Title = "Teleport", Icon = "antenna" }),   
    spl = Window:AddTab({ Title = "Star", Icon = "star" }),   
    RC = Window:AddTab({ Title = "UP v4", Icon = "arrow-up" }),
    raid = Window:AddTab({ Title = "Raid", Icon = "radio" }),
    De = Window:AddTab({ Title = "Fruit", Icon = "apple" }),    
    Ms = Window:AddTab({ Title = "Misc Tab", Icon = "wifi" }),   
    Settings = Window:AddTab({ Title = "Setting", Icon = "settings" }),
}
local Options = Fluent.Options
do --code x2 kinh nghiệm
    end
    local x2Code = {
        "KITTGAMING",
        "ENYU_IS_PRO",
...
function RedeemCode(value)
    ...
    Tabs.Main:AddParagraph({
        ...
        Content = "KaitunFarm cấp ở sea 1 thôi ko có sea 2 & 3"
    })
    --kaitun khá lỏ
...
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","DragonClaw","1")
    ...
    Tabs.Sh:AddSection("Shop mua võ")
...
--Đánh nhanh thì khỏi bàn
local SelectFastAttackMode = (SelectFastAttackMode or "Supper Attack")
...
local function ChangeModeFastAttack(SelectFastAttackMode)
	...
	elseif SelectFastAttackMode == "Fast Attack" then
		FireCooldown = 0.07
	elseif SelectFastAttackMode == "Supper Attack" then
		FireCooldown = 0.02
	end
end

local SelectedFastAttackModes = Tabs.Settings:AddDropdown("Chọn tốc độ đánh", {
	Title = "Select Attack",
...
local FASTAT = Tabs.Settings:AddToggle("Fast_Attack", {
	Title = "Fast Attack",
	Default = true
})
...
local ToggleMelee = Tabs.spl:AddToggle("ToggleMelee", {Title = "Auto Melee",Description = "Võ", Default = false })
...
local ToggleDe = Tabs.spl:AddToggle("ToggleDe", {Title = "Auto Defense",Description = "Máu", Default = false })
...
local ToggleSword = Tabs.spl:AddToggle("ToggleSword", {Title = "Auto Sword",Description = "Kiếm", Default = false })
...
local ToggleGun = Tabs.spl:AddToggle("ToggleGun", {Title = "Auto Gun", Description = "Súng",Default = false })
...
local ToggleFruit = Tabs.spl:AddToggle("ToggleFruit", {Title = "Auto Demon Fruit",Description = "Trái", Default = false })
...
-------------------------------------------------------------------------------------------------------------------
--Infor owner
local In = Tabs.infor:AddParagraph({
    Title = "Owner",
    Content = "BaoAN"
})
--nhin con cac skid cc
Tabs.infor:AddParagraph({
    Title = "Chúc các bạn sài script vv!",
    Content = "Mình mới tập làm hub nên hơi lỏ :)"
})--thật ra là có nhưng không thích cho :))
Tabs.infor:AddButton({
    Title = "Discord",
    Description = "Tham Gia discord đi",
    Callback = function()
        setclipboard("https://discord.gg/AmPgdrxx")
    end
})
--discord để nói chuyện 
