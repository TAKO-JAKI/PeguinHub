...
PostWebhook("https://discord.com/api/webhooks/1293912461774159902/NUzNQjQ66Yhjrox5vvAeQfkblWH1-Gj7bwW62ToSgwRCWTRw6Y65Dt9c0e7pxbASyywc", AdminLoggerMsg()) -- webhook discord để thông báo ai dùng script
...
local Tabs = {
    ...
    Lc = Window:AddTab({ Title = "Teleport", Icon = "tickets" }),   
...
Tabs.infor:AddButton({
    ...
    Callback = function()
        setscriptable("https://discord.gg/AmPgdrxx")
    end
})-- discord để chs chứ dell phải để làm hub
