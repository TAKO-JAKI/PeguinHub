...
NotificationLibrary:SendNotification("Success", "Load Successfully", 10)
...
-------------------------------------------------------------------------------------------------------------------
--Infor owner
local Infor = Tabs.infor:AddParagraph({
    Title = "Owner",
    Content = "BaoAN"
})
...
------------------------------------------------------------------------------------------------------------------------------------------------------
--Sự kiện biển , săn sea
local SeaLevel = Tabs.Se:AddDropdown({
    Title = "Seclect Sea Lever",
    Values = {"1" "2" "3" "4" "5" "6" },
    Multi = false,
    Default = 6
})
...
--auto ken khi có sấm
local GetRough = Tabs.Se:AddToggle("Auto_Rough_Sea", {
...
-- đọc chữ dùm con 
local TerrorsharkFarm = Tabs.Se:AddToggle("Terrorshark", {
    Title = "Auto Terrorshark",
    Default = Terrorshark
})
Tabs.Se:AddToggle("TerrorsharkHop", {
    Title = "Auto Terrorshark [HOP]",
    Default = TerrorsharkHop
}):OnChanged(function(starts)
    TerrorsharkHop = starts
end)
Tabs.Se:AddToggle("Auto_Boat", {
    Title = "Auto Boat",
    Default = true
}):OnChanged(function(starts)
    Auto_Boat = starts
end)
Tabs.Se:AddToggle("Auto_Shark", {
    Title = "Auto Shark",
    Default = true
}):OnChanged(function(starts)
    Auto_Shark = starts
